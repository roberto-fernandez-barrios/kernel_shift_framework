...
The canonical v0.8.0 release gates are
\begin{verbatim}
python scripts/reproduce_v8.py --stage all
python -m pytest tests -q
\end{verbatim}
The circuit-aware strata, within-v4 factorial, shortcut ablation, and resource
outputs are under \texttt{results/v8/}; the corrected three-source inference,
budget, rank, and finite-shot outputs remain under \texttt{results/v6/}.
Frozen legacy/v4/v5 artifacts remain unchanged. The development repository is
\url{https://github.com/roberto-fernandez-barrios/kernel_shift_framework},
and the concept archive is
\url{https://doi.org/10.5281/zenodo.19147649}. The exact v0.8.0 submission

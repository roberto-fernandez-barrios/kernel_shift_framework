...
Experiments use Python 3.11/3.12, NumPy 2.3.5, pandas 2.2.3, scikit-learn 1.8.0, Matplotlib 3.11.0, and Qiskit 2.3.1. The exact cross-platform environment is pinned. Code, manifests, tests, aggregated results, and figure/table generators are available at \url{https://github.com/roberto-fernandez-barrios/kernel_shift_framework}. The immutable submission release will be archived under the version DOI stated in the Code availability declaration; the concept DOI resolves all versions.

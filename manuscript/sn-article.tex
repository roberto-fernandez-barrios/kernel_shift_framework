...
This study uses the public EMBER \cite{anderson2018ember}, UNSW-NB15 \cite{moustafa2015unsw}, ToN-IoT \cite{alsaedi2020toniot}, and TableShift \cite{gardner2023tableshift} benchmarks, which remain subject to their original access conditions. Raw TableShift records are not redistributed. Derived split definitions, deterministic row-position hashes, shift constructions, experiment manifests, aggregated results, and summary tables are available in the Zenodo repository at \url{https://doi.org/10.5281/zenodo.19147649}.

...
We do not claim universal superiority, equivalence, complexity-theoretic advantage, hardware relevance, or a refutation of quantum kernels. The open problem is whether a label-free, train-only signal can select a robust kernel under shift; label-free drift detection \cite{yang2021cade} and task--model alignment theory \cite{bordelon2020spectrum,canatar2021taskmodel,ma2023covariate} provide starting points. Answering it would benefit both families: the operative question is which similarity geometry aligns with the encountered shift and how to identify it without target labels. This interpretation is consistent with calls for controlled QML benchmarking \cite{bowles2024betterthanclassical,schnabel2025scrutiny,kakavand2026benchmarking}.

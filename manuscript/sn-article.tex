...
The comparison is coupled to a geometry audit. We measure effective rank, centered kernel-target alignment, concentration, and geometric difference \cite{roy2007effective,cristianini2001kta,cortes2012centeredalignment,huang2021powerofdata}; use partial association, leave-one-source-dataset-out prediction, and effective-rank matching to restrict interpretation; and repeat finite-shot perturbations under unprojected, independent-square PSD, and coherent train-eigenspace PSD estimators.
...
Experiments use Python 3.11/3.12, NumPy 2.3.5, pandas 2.2.3, scikit-learn 1.8.0, Matplotlib 3.11.0, and Qiskit 2.3.1. The exact cross-platform environment is pinned. Code, manifests, tests, aggregated results, and figure/table generators are available at \url{https://github.com/roberto-fernandez-barrios/kernel_shift_framework}. The exact v0.7.0 submission release is archived under the immutable DOI \url{https://doi.org/10.5281/zenodo.21676563} \cite{fernandezbarrios2026artifactv07}; the concept DOI resolves all versions.

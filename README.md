...
8. The bounded-loss identified interval is sharp and minimal for the finite-batch functional comparing a fixed candidate with the best member of a prespecified fixed family under unrestricted label completions; for zero--one accuracy it reduces to disagreement closed forms and is pathwise exact after any realized audit subset. Across the frozen 30/60/115 reference breadths, the median zero-label upper endpoint across 16 security cells contracts from **0.042 to 0.034 to 0.034**.
...
# reference-breadth summary, literature positioning, and v1.1 manuscript gates.

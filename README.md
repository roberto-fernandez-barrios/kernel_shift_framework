...
The main manuscript and Supplementary Information live in [`manuscript/`](manuscript/) (Springer Nature-compatible main source plus a standalone Supplementary file). If you use this software, please cite the immutable v1.1.0 release via [`CITATION.cff`](CITATION.cff) and [10.5281/zenodo.21750725](https://doi.org/10.5281/zenodo.21750725). The immutable v0.8.0 predecessor is [10.5281/zenodo.21717074](https://doi.org/10.5281/zenodo.21717074); the all-version concept DOI is [10.5281/zenodo.19147649](https://doi.org/10.5281/zenodo.19147649).
